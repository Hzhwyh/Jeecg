...
<head>
    ...
    <meta name="keywords" content="NOW直播秀出你的姿态">
    <meta name="description" content="我的青春我做主">
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <%--dangzhenghui begin 20170502 for 增加添加头像功能--%>
                                <span><img alt="image" width="100%" height="61" src="images/home.jpg" style="opacity: 0.3" /></span>
                ...
                <div class="navbar-header" style="height: 60px;"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                    <form role="search" class="navbar-form-custom" method="post" action="search_results.html">
                        <div class="form-group">
                            <input type="text" placeholder="欢迎使用该系统 …" class="form-control" name="top-search" id="top-search">
                        </div>
                    </form>
                </div>
