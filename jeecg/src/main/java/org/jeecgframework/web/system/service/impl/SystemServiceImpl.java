...
//		log.setTSUser(ResourceUtil.getSessionUser());
	...
	@Override
	public void updateSystemOrg(String departId, String departname) {
		String updateSql = "update a_artist set orgname=? where orgid=?";
		this.executeSql(updateSql,departId,departname);
		updateSql = "update a_ruls set orgname=? where orgid=?";
		this.executeSql(updateSql,departId,departname);
	}
